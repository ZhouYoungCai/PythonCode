...
# 打印函数 comments 的内容
print(f"打印函数 comments 的内容",func_with_params.__doc__)
...
func_with_params(1, 2, 3)  #位置参数

#func_with_params(1, 2, 3, 4)   #位置参数错误例子，数量错误
func_with_params(2, 1, 3)

#person(20, "lily")   #位置参数错误例子，顺序错误
person("lily", 20)

person(age=12, name="Tom",nationality="美国")  #关键字传参