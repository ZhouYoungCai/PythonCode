...
t = (1,3,2,3,2)
print(t.index(3))   #打印数字3的index是：1
t = ('h', 'o', 'g', 'w', 'a', 'r', 't', 's')   # 元组常用方法index()    --index(item)
print(t.index('a'))   # 打印4，返回与目标元素相匹配的首个元素的索引。目标必须在元组中存在的，否则会报错

t = (1, 2, 2, 3, 3, 3, 3)
print(f"3出现的次数是：",t.count(3),"次")  #打印3出现的次数：4
t = ('h', 'o', 'o', 'o', 'g', 'w', 'a', 'r', 't', 's')
print(f"a出现的次数是：",t.count('a'),"次")  #打印a出现的次数：1

t = (1, 2, 3)
a = t[0]
b = t[1]
c = t[2]
print(a,b,c)  # 传统逐个赋值的方式
